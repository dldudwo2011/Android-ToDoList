...
public class SetPasswordDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.custom_dialog_password, null);
        ...
        builder.setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        // change password
                        listener.onChangePassword(SetPasswordDialogFragment.this);
                        EditText editText = v.findViewById(R.id.password);
                        MainActivity.password = editText.getText().toString();
                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        SetPasswordDialogFragment.this.getDialog().cancel();
                    }
                });
